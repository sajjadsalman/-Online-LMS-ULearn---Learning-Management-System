...
<html lang="en">
    ...
    <body class="bg-danger">
        <nav class="navbar fixed-top shadow">
            <a href="login.php"><i class="ms-3 fa-solid fa-hippo fa-2xl" style="color: #ff8800;"></i></a>
            <p class="m-0 text-warning">ULearn</p>
            <a class="me-3 link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="sign.php">Register</a>
        </nav>
        <?php
